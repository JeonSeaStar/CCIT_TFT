...
public class DailyRankLoader : MonoBehaviour
{
    ...
    {
        //1~20위 랭킹 정보 불러오기
        //rankUuid 랭킹 테이블에 있는 유저의 offset ~ offset + limit 순위 랭킹 정보를 불러옴
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        for(int i =0; i < rankerCount; i++)
                        {
                            ...
                            //닉네임은 별도로 설정하지 않는 유저도 존재할 수 있기 때문에 닉네임이 존재하지 않는 유저는 닉네임 대신 gamerId를 출력
    ...
    private void GetMyRank()
    {
        ...
        {
            //닉네임이 없으면 gameId, 닉네임이 있으면 nickname 사용
            ...
            if (callback.IsSuccess())
            {
                ...
                try
                {
                    ...
                    else
                    {
                        ...
                        //닉네임은 별도로 설정하느 않은 유저도 존재할 수 있기 때문에 닉네임이 존재하지 않는 유저는 닉네임 대신 gameId를 출력
