...
public class HermitKing : Piece
{
    ...
    public override void DoAttack()
    {
        ...
        {
            invincible = false;
            SoundManager.instance.Play("Shell_Series/S_Attack_HermitKing", SoundManager.Sound.Effect);
            Damage(attackDamage);
            mana += manaRecovery;
            StartNextBehavior();
        }
    ...
    public void AttackSpeedUp(float time, float rof)
    {
        ...
        {
            SkillState();
            SoundManager.instance.Play("Shell_Series/S_Skill_HermitKing", SoundManager.Sound.Effect);
    ...
    {
        SoundManager.instance.Play("Shell_Series/S_Death_HermitKing", SoundManager.Sound.Effect);
        StopAllCoroutines();
