...
public class DragonFire : Piece
{
    ...
    public override void DoAttack()
    {
        ...
        {
            invincible = false;
            SoundManager.instance.Play("Dragon_Series/S_Attack_DragonFire", SoundManager.Sound.Effect);
            Damage(attackDamage);
            mana += manaRecovery;
            StartNextBehavior();
        }
    ...
    public void DamageMultiSkill(float damage) // -- 변경 필요할 수 있음
    {
        ...
        {
            SkillState();
            SoundManager.instance.Play("Dragon_Series/S_Skill_DragonFire", SoundManager.Sound.Effect);
    ...
    {
        SoundManager.instance.Play("Dragon_Series/S_Death_DragonFire", SoundManager.Sound.Effect);
        StopAllCoroutines();
