    ...
    public override void DirectEffect(Piece piece, bool isAdd)
    {
        if (isAdd)
        {
            if (isOnce == false)
            {
                ...
                captainDog.attackDamage += captainDog.pieceData.attackDamage[_star] * 0.15f;
        ...
        if (isAdd)
        {
            ...
            if (_tileGridX != 0)
            {
                ...
                if (_leftPiece != null)
                {
                    ...
                    _leftPiece.armor += _leftPiece.pieceData.armor[_leftPiece.star] * 0.1f;
                }
            }
            ...
            if (_tileGridX != 6)
            {
                ...
                if (_rightPiece != null)
                {
                    ...
                    _rightPiece.armor += _rightPiece.pieceData.armor[_rightPiece.star] * 0.1f;
                }
            }
        }
        else if (isAdd == false)
